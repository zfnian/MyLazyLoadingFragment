...
//        dumpLifeCycle("onViewStateRestored");
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        Log.i("zhaofn", mFragment.getClass().getSimpleName() + " -> setUserVisibleHint isVisibleToUser: " + isVisibleToUser + " =============");
    }
...
//        dumpLifeCycle("onConfigurationChanged");
    ...
    public void dumpLifeCycle(final String method) {
        Log.i("zhaofn", "name: " + mFragment.getClass().getSimpleName() + " -> " + method);
    }
}
